...
class PriceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        return models.PriceTable.objects.create(
                    id_fuel=models.Fuel.objects.filter(id=validated_data['id_fuel']).first(),
                    id_region=models.Region.objects.filter(id=validated_data["id_region"]).first(),
                    id_fuel_operator=models.FuelOperator.objects.filter(id=validated_data['id_fuel_operator']).first(),
